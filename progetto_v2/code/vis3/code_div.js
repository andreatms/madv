...
function initializeGraph() {
  svg = d3
    .select(".container")
    .append("svg")
    .attr("width", window.innerWidth - d3.select("#sidebar-container").innerWidth - d3.select("#ranking-container").innerWidth)
    .attr("height", window.innerHeight * .86)
    .style("border", "2px #2B3E50 solid")
    .style("border-radius", "8px")
